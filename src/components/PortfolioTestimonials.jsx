...
const projects = [
  ...
  { title: 'Vela App', tag: 'Product Design + Dev', gradient: 'from-emerald-500/20 to-emerald-300/10' },
  { title: 'Noir Studio', tag: 'Website Redesign', gradient: 'from-white/10 to-white/0' },
  { title: 'Harbor & Co.', tag: 'Social Campaign', gradient: 'from-emerald-500/15 to-emerald-400/10' },
